...
import CourierAuthGate from './components/CourierAuthGate';
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <main>
        <Routes>
                ...
                <Route path="/shop/crm" element={<ShopCrm />} />
                <Route path="/shop/orders" element={<ShopOrders />} />
                <Route path="/success" element={<OrderSuccess />} />     {/* ← Добавь этот маршрут */}
                <Route path="/shop/orders/:orderId/chat" element={<ShopChat />} />     {/* ← Добавь этот маршрут */}
                <Route path="/orders" element={<CustomerOrders />}/>
                <Route path="/orders/:orderId/chat" element={<CustomerChat />}/>
                <Route path="/notifications" element={<Notifications />} />
                <Route path="/settings/notifications" element={<NotificationSettings />} />
